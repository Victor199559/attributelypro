...
import { 
  ...
  Eye, Settings, Home, Bot, Crosshair, User, FileText
} from 'lucide-react';
...
// Sidebar Component (IGUAL QUE AUDIENCIAS Y REPORTS)
function Sidebar() {
  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { name: 'Audiencias', icon: Users, href: '/audiences', active: false, badge: 'Neural' },
        ...
        { name: 'Analytics', icon: TrendingUp, href: '/analytics', active: true, badge: 'Live' },
        { name: 'Reportes', icon: FileText, href: '/reports', active: false, badge: 'AI' }
      ]
    },
    {
      title: 'AI ENGINE',
            ...
            <div key={sectionIndex}>
              ...
              <div className="space-y-1">
                {section.items.map((item, itemIndex) => {
                  ...
                  const isActive = pathname === item.href || (item.href === '/analytics' && pathname?.startsWith('/analytics'));
