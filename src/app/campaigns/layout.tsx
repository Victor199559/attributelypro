  ...
  const menuItems = [
    {
      ...
      items: [
        ...
        { name: 'Campañas', icon: Target, href: '/campaigns', active: true, badge: '5' },
            ...
            <div key={sectionIndex}>
              ...
              <div className="space-y-1">
                {section.items.map((item, itemIndex) => {
                  ...
                  const isActive = pathname === item.href || (item.href === '/campaigns' && pathname?.startsWith('/campaigns'));
                      ...
                      {item.badge && (
                        <span 
                          className={`px-2 py-0.5 text-xs font-medium rounded-full ${
                            isActive ? 'bg-white bg-opacity-20 text-white' : getBadgeStyle(item.badge)
                          }`}
                        >
                          {item.badge}
                        </span>
